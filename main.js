...
function init() {
  ...
  canvas.addEventListener('pointerdown', e => {
    renderer.clickPosition = [e.clientX, e.clientY]
  })
}
...
class Renderer {
  ...
  setup() {
    ...
    this.clickPositionUniform = gl.getUniformLocation(this.program, 'clickPosition')
    this.clickRadiusUniform = gl.getUniformLocation(this.program, 'clickRadius')
    this.clickDurationUniform = gl.getUniformLocation(this.program, 'clickDuration')
  }
  ...
  render(now = 0) {
    ...
    if (this.clickPosition) {
      gl.uniform2f(this.clickPositionUniform, this.clickPosition[0], this.clickPosition[1])
      gl.uniform1f(this.clickRadiusUniform, 50.0)
      gl.uniform1f(this.clickDurationUniform, 0.5)
    }
